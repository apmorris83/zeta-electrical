...
const Header = () => {
  ...
  return (
    <header className={`fixed w-full z-30 bg-gray-100 transition duration-300 ease-in-out ${!top && 'bg-white blur shadow-lg'}`}>
      <div className="max-w-6xl mx-auto sm:flex sm:justify-between">
        <div className="flex items-center justify-between px-4 py-6">
          <div>
            <Link to="/" className="p-2 block rounded focus:outline-none focus:shadow-outline focus:border-blue-300">
              <svg className="fill-current text-yellow-800 h-8" viewBox="0 0 100 46">
